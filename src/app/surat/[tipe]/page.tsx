...
import SuratKeteranganFlexibel from "@/app/components/form/SuratKeteranganFlexibel";
...
export default function Page(): JSX.Element {
  ...
  switch (tipe) {
    ...
    case "usaha":
      ...
      break;
    case "surat_keterangan_flexibel":
      componentToRender = <SuratKeteranganFlexibel tipe={tipe} />;
      break;
    default:
