...
const HeroSection = () => {
  return (
   <section className='min-h-screen relative flex items-center justify-center flex-col text-center text-white gap-4'>
        <img src="/png/bg-home.png" className='absolute w-screen object-cover -z-20'/>
        <div className='size-full bg-black absolute opacity-50 -z-10'></div>
        <div className='w-full flex justify-center absolute inset-0 mt-10 py-3.5 px-5'>
            <div className='bg-white w-[50%] h-fit px-5 py-3.5 rounded-2xl justify-between flex flex-row items-center'>
        ...
        <h1 className='w-full text-8xl font-bold'>DESA WRINGINANOM</h1>
