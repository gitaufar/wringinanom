...
export default function SuratKeteranganKuasa({ tipe }: SuratKeteranganKuasaProps) {
  const initialData = {
    NamaPengaju: "",
    Kotalahir:" ",
    TanggalLahir: "",
      ...
      <div className="w-full pt-20">
        ...
        <div className="flex justify-center items-center px-4 md:px-8 lg:px-[170px]">
          ...
          >
            ...
            <h1 className="text-black text-[32px] lg:text-[40px] font-bold mt-10">
              Data Penerima Kuasa
            </h1>
            ...
            <InputField
              inputLabel="Hubungan dengan Pengaju"
              inputPlaceholder="Hubungan dengan Pengaju"
              data={formData.HubunganDenganPengaju}
              setData={(val) => setFormData({ ...formData, HubunganDenganPengaju: val })}
              setEditData={setEditData}
              editData={editData}
              submited={submited}
            />
