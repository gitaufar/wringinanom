...
export default function BedaIdentitasForm() {
  ...
  const [namaLama, setNamaLama] = useState("Co. Regas");
  const [namaBaru, setNamaBaru] = useState("Co. Ryan");
      ...
      <div className="w-full pt-24 px-5 lg:px-[170px]">
        ...
        <div className="max-w-4xl mx-auto bg-white shadow p-8 rounded-[15px] space-y-8">
          ...
          <div className="space-y-3">
            ...
            <InputField inputLabel="Nama Lama" inputPlaceholder="Nama Lama" data={namaLama} setData={setNamaLama} setEditData={setEdit} editData={edit} submited={submited} />
            <InputField inputLabel="Nama Baru" inputPlaceholder="Nama Baru" data={namaBaru} setData={setNamaBaru} setEditData={setEdit} editData={edit} submited={submited} />
