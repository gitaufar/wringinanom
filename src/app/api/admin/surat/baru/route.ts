...
export async function GET(req: NextRequest): Promise<NextResponse> {
  ...
  const templateFiles: { [key: string]: string } = {
    ...
    "kehilangan": "Surat_Keterangan_Kehilangan_Kepolisian_(ADMIN).docx",
    "pengantar": "A.04.03_Surat_Pengantar_(FINAL).docx",
    "tidak-mampu": "Surat_Keterangan_Tidak_Mampu_(ADMIN).docx",
    "wali-nikah": "Surat_Keterangan_Wali_Nikah_(ADMIN).docx",
    "wali-murid": "B.03.03_Surat_Keterangan_Wali_Murid_(A4)_(FINAL).docx",
    "domisili-baru": "Surat_Keterangan_Domisili_(ADMIN).docx",
    ...
    "usaha": "Surat_Keterangan_Usaha_(ADMIN).docx",
  };
  ...
  try {
    ...
    const dataToRender = {
      ...
      Alamat: `Dusun ${penduduk.alamat} RT ${penduduk.rt} RW ${penduduk.rt} Desa Wringinanom Kecamatan Poncokusumo Kabupaten Malang`,
