      ...
      <RiwayatProvider>
        <PermohonanProvider>
          <div className="flex flex-row pl-64 bg-[#F5F6FA] min-h-screen">
            {/* Navbar */}
            <nav className="bg-white fixed top-0 left-0 right-0 ml-64 h-[55px] px-10 py-2 flex justify-between items-center z-10 shadow-sm">
  {/* Tulisan kiri */}
  <div className="text-black-700 font-bold text-lg">
    Administrasi Desa Wringinanom
  </div>
